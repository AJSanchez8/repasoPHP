...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
            <div class="card">
                <div class="card-header display-6">ELIMINAR ARTICULO</div>
                <div class="p-4">  
                    <?php
                        ...
                        <table class="table table-primary">
                            ...
                            <tbody>
                                ...
                                <tr class="align_middle">
                                    ...
                                    <td><a href="baja2.php?id=<?php echo $registro[0];?>"><i class="bi-trash px-1" style="font-size: 3rem; color:red;"> </i></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
