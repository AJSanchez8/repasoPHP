...
<div class="container my-5">
    <div class="row">
        <div class="col text-center">
            <div class="card">
                <div class="card-header display-6">STOCK ARTICULOS</div>
                <div class="p-4">  
                        ...
                        <table class="table table-primary">
                            ...
                            <?php foreach($resultado as $registro){?>
                                <tr class="align_middle">
                                    ...
                                    <td><a href="baja2.php?id=<?php echo $registro['id_producto'];?>"><i class="bi-trash px-1" style="font-size: 3rem; color:red;"> </i></a></td>
